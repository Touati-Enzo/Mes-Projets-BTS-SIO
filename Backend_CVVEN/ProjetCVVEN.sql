...
--
-- Hôte : localhost
-- Généré le : jeu. 16 avr. 2026 à 21:37
...
--
-- Structure de la table `gestion_auth`
--

CREATE TABLE `gestion_auth` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `gestion_auth`
--

INSERT INTO `gestion_auth` (`id`, `login`, `mdp`) VALUES
(1, 'admin', '1234');
...
(2, 15, '102', '2026-01-13', '2026-01-14', 255.00, 2, '2026-01-12 15:31:38', '2026-03-30 15:54:44', 'annulee'),
...
(8, 15, '101', '2026-01-30', '2026-02-01', 160.00, 2, '2026-01-29 18:00:54', '2026-03-30 15:10:53', 'confirmee');
...
CREATE TABLE `users` (
  ...
  `abonnement` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `email`, `username`, `first_name`, `last_name`, `password`, `role`, `created_at`, `updated_at`, `phone`, `address`, `abonnement`) VALUES
(1, 'admin@example.com', 'admin', '', '', '$2y$10$IbRSOy8Ew3BTqd65Nk2vj.jBxJAmxHYVI6vKOHr/rbcH9rb5ApLmK', 'admin', '2025-12-01 16:32:25', '2025-12-01 16:41:25', NULL, NULL, NULL),
(19, 'emailtest@gmail.com', 'test', 'user', 'test', '$2a$10$Wp8HnDkdIhBDPfIjoTz.OeEDnkeLxS2PwTRZAvIbxVZc/A8TAWEmG', 'user', '2026-03-30 13:08:19', '2026-04-15 08:16:55', NULL, NULL, 'Individuel');
...
--
-- Index pour la table `gestion_auth`
--
ALTER TABLE `gestion_auth`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `gestion_auth`
--
ALTER TABLE `gestion_auth`
